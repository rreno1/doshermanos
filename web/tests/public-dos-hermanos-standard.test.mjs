...
test('public portal uses the same Dos Hermanos header and navigation primitives as management', () => {
...
test('public portal foundation follows the Dos Hermanos public contract', () => {
