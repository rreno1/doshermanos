...
test('tables with status or state data retain an explicit status-priority column', async () => {
  for (const relativePath of statusPriorityScreens) {
    const source = await readFile(new URL(relativePath, import.meta.url), 'utf8');
