...
export function EquipmentReturnDialog({ assignment, staff, onClose }: Props) {
  ...
  return (
    <dialog
      ...
      aria-labelledby="equipment-return-dialog-title"
      onClose={onClose}
    >
      <form className="equipment-dialog-panel" onSubmit={handleSubmit}>
        <div className="equipment-dialog-heading">
          ...
          <button
            ...
            aria-label="Close equipment return form"
            onClick={onClose}
          >
            ×
          </button>
        ...
        <p
          className={
            assignment && accountedQuantity === assignment.assignedQuantity
              ? 'equipment-accounted equipment-accounted-complete'
              : 'equipment-accounted'
          }
          aria-live="polite"
        >
          Accounted: {Number.isFinite(accountedQuantity) ? accountedQuantity : 0} /{' '}
        ...
        <label className="equipment-field">
          ...
          <textarea
            ...
            placeholder="Describe damage, missing items, or other return details"
          />
        </label>
        ...
        <div className="equipment-dialog-actions">
          ...
          <button type="submit" className="equipment-primary-button" disabled={isSaving || !assignment}>
